...
class VQModel(nn.Module):
    ...
    def _set_intermediate(self):
        ...
        self.handles = []
        self.handles.append(self.decoder.norm_out.register_forward_hook(self._layer_forward_hook("output_feature")))
    ...
    def _get_intermediate(self):
        return self.intermediate_layers_feat

    def _release_intermediate(self):
        for handle in self.handles:
            handle.remove()
        del self.intermediate_layers_feat
